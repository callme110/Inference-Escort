...
from inference_escort.input_scanners.ban_substrings import MatchType as BanSubstringsMatchType
...
def main():
    parser = argparse.ArgumentParser(description="Benchmark scanners in inference-escort library.")
    parser.add_argument(
