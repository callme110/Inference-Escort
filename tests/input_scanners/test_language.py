...
from inference_escort.input_scanners.language import Language, MatchType
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            MatchType.SENTENCE,
            "Hello, my name is Inference-Escort, and I'm a Python tool for detecting malicious prompts. Me llamo Inference-Escort, y soy una herramienta de Python para detectar indicaciones maliciosas. Bonjour, je m'appelle Inference-Escort et je suis un outil Python pour détecter les invites malveillantes.",
            False,
            1.0,
