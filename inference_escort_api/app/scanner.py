...
from inference_escort import input_scanners, output_scanners
from inference_escort.input_scanners.anonymize_helpers import DEBERTA_AI4PRIVACY_v2_CONF
from inference_escort.input_scanners.ban_code import MODEL_SM as BAN_CODE_MODEL
from inference_escort.input_scanners.ban_competitors import MODEL_V1 as BAN_COMPETITORS_MODEL
from inference_escort.input_scanners.ban_topics import MODEL_DEBERTA_BASE_V2 as BAN_TOPICS_MODEL
from inference_escort.input_scanners.base import Scanner as InputScanner
from inference_escort.input_scanners.code import DEFAULT_MODEL as CODE_MODEL
from inference_escort.input_scanners.gibberish import DEFAULT_MODEL as GIBBERISH_MODEL
from inference_escort.input_scanners.language import DEFAULT_MODEL as LANGUAGE_MODEL
from inference_escort.input_scanners.prompt_injection import V2_MODEL as PROMPT_INJECTION_MODEL
from inference_escort.input_scanners.toxicity import DEFAULT_MODEL as TOXICITY_MODEL
from inference_escort.model import Model
from inference_escort.output_scanners.base import Scanner as OutputScanner
from inference_escort.output_scanners.bias import DEFAULT_MODEL as BIAS_MODEL
from inference_escort.output_scanners.malicious_urls import DEFAULT_MODEL as MALICIOUS_URLS_MODEL
from inference_escort.output_scanners.no_refusal import DEFAULT_MODEL as NO_REFUSAL_MODEL
from inference_escort.output_scanners.relevance import MODEL_EN_BGE_SMALL as RELEVANCE_MODEL
...
def _get_input_scanner(
    ...
    *,
    ...
    if scanner_name == "EmotionDetection":
        from inference_escort.input_scanners.emotion_detection import (
