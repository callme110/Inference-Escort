...
prompts: [output_stop_substrings.json](https://github.com/callme110/Inference-Escort/blob/main/inference_escort/resources/output_stop_substrings.json)
...
```python
from inference_escort.output_scanners import BanSubstrings
