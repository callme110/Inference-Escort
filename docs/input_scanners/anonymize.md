...
- **Entities support**:
    - Peek at
    our [default entities](https://github.com/callme110/Inference-Escort/blob/main/inference_escort/input_scanners/anonymize.py#L26-L40).
    - View
    the [Presidio's supported entities](https://microsoft.github.io/presidio/supported_entities/#list-of-supported-entities).
    - And, we've
    got [custom regex patterns](https://github.com/callme110/Inference-Escort/blob/main/inference_escort/resources/sensisitive_patterns.json)
    too!
...
```python
from inference_escort.input_scanners import Anonymize
from inference_escort.input_scanners.anonymize_helpers import BERT_LARGE_NER_CONF
