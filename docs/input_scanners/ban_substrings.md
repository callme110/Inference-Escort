...
2. Prevent harmful substrings for prompts: [prompt_stop_substrings.json](https://github.com/callme110/Inference-Escort/blob/main/inference_escort/resources/prompt_stop_substrings.json).
...
```python
from inference_escort.input_scanners import BanSubstrings
from inference_escort.input_scanners.ban_substrings import MatchType
