...
from inference_escort.input_scanners.anonymize import (
    ALL_SUPPORTED_LANGUAGES,
    DEFAULT_ENTITY_TYPES,
    Anonymize,
)
from inference_escort.input_scanners.anonymize_helpers import (
    DEBERTA_AI4PRIVACY_v2_CONF,
    get_analyzer,
    get_regex_patterns,
    get_transformers_recognizer,
)
from inference_escort.input_scanners.anonymize_helpers.ner_mapping import NERConfig
    ...
    def __init__(
        ...
        *,
        ...
        if language not in ALL_SUPPORTED_LANGUAGES:
            raise InferenceEscortValidationError(
